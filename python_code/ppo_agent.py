...
class PPOAgent:
    ...
    def save(self, actor_name, critic_name):
        ...
        print("\nMedian average score: ", np.median(self.averages))
        print("Median average steps: ", np.median(self.averages_steps))
        print("\nStd average score: ", np.std(self.averages))
        print("Std average steps: ", np.std(self.averages_steps))
        print("\nVar average score: ", np.var(self.averages))
        print("Var average steps: ", np.var(self.averages_steps))
